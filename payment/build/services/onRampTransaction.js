...
const onRampTransaction = (amount, provider) => __awaiter(void 0, void 0, void 0, function* () {
    const onRampTxn = yield (0, onRampTransaction_1.startOnRampTransaction)({ amount, provider });
    return onRampTxn;
});
